<header class="header" data-sticky="true">
                ...
                <div class="header__actions"><a href="#">Login & Regiser</a>
                  <div class="btn-group ps-dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">USD<i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu">
                      <li><a href="#"><img src="{{asset('/')}}frontend/assets/images/flag/usa.svg" alt=""> USD</a></li>
                      <li><a href="#"><img src="{{asset('/')}}frontend/assets/images/flag/singapore.svg" alt=""> SGD</a></li>
                      <li><a href="#"><img src="{{asset('/')}}frontend/assets/images/flag/japan.svg" alt=""> JPN</a></li>
                    </ul>
                  </div>
                  <div class="btn-group ps-dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Language<i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu">
                      <li><a href="#">English <img src="{{asset('/')}}frontend/assets/images/flag/usa.svg" alt=""></a></li>
                      <li><a href="#">Japanese <img src="{{asset('/')}}frontend/assets/images/flag/japan.svg" alt=""></a></li>
                    </ul>
                  </div>
                </div>
              </div>
    ...
    <nav class="navigation">
      <div class="ps-container"><a class="ps-logo" href="index-2.html"><img src="{{asset('/')}}frontend/assets/images/logo.png" alt=""></a>
        ...
        <div class="ps-cart"><a class="ps-cart__toggle" href="#"><span><i>20</i></span><img src="{{asset('/')}}frontend/assets/images/market.svg" alt=""></a>
          <div class="ps-cart__listing">
            <div class="ps-cart__content">
              <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                <div class="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img src="{{asset('/')}}frontend/assets/images/shopping-cart/1.jpg" alt=""></div>
                <div class="ps-cart-item__content"><a class="ps-cart-item__title" href="product-detail.html">Kingsman</a>
                  <p><span>Quantity:<i>12</i></span><span>Total:<i>£176</i></span></p>
                </div>
              </div>
              <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                <div class="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img src="{{asset('/')}}frontend/assets/images/shopping-cart/2.jpg" alt=""></div>
                <div class="ps-cart-item__content"><a class="ps-cart-item__title" href="product-detail.html">Joseph</a>
                  <p><span>Quantity:<i>12</i></span><span>Total:<i>£176</i></span></p>
                </div>
              </div>
              <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                <div class="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img src="{{asset('/')}}frontend/assets/images/shopping-cart/3.jpg" alt=""></div>
