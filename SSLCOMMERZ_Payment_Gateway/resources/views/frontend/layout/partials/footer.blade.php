      ...
      <div class="ps-container">
        <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                <div class="ps-site-info site-info"><a class="ps-logo" href="index-2.html"><img src="{{asset('/')}}frontend/assets/images/logo.png" alt=""></a>
      ...
      <div class="ps-container">
        <div class="row">
              ...
              <div class="col-lg-4 col-md-5 col-sm-12 col-xs-12 ">
                <div class="ps-footer__payment-methods"><a href="#"><img src="{{asset('/')}}frontend/assets/images/payment-method/paypal.png" alt=""></a><a href="#"><img src="{{asset('/')}}frontend/assets/images/payment-method/visa.png" alt=""></a><a href="#"><img src="{{asset('/')}}frontend/assets/images/payment-method/master-card.png" alt=""></a></div>
              </div>
        </div>
      </div>
    </div>
